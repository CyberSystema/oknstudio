...
export const en = {
  ...
  'zone.status.live': 'Live · in browser',
  'zone.status.live.title': 'Runs entirely in your browser. No uploads.',
  ...
  'zone.status.serverOnly': 'Server-only · coming soon',
  'zone.status.serverOnly.title': 'This module runs entirely on the processing server, which isn’t live yet.',

  'status.legend.title': 'Module availability',
  'status.legend.live': 'Runs entirely in your browser',
  'status.legend.partial': 'Some options wait for the processing server',
  'status.legend.serverOnly': 'Entire module needs the processing server — not available yet',
